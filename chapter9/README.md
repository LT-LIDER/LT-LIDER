...
- **Task 1**: Fine-tune multiligual NMT model
  ...
  - Download the Python notebook (finetune_LoRANLLB_en_cat_FLORES.ipynb) from the notebooks directory and upload it into colab
  - Download the English-Catalan parallel data tiles (.txt) from the data directory and upload them into colab
- **Task 2**: Back-translation of tuned multiligual NMt model
  - TODO
